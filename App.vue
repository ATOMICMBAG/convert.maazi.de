...
<template>
  ...
  >
    ...
    >
      <span class="font-bold text-4xl text-black ml-[60px]">maazi.de</span>
      <h1 class="text-xl font-bold text-gray-900"></h1>
      <span class="text-xl font-bold text-black mr-[60px]">Text Converter</span>
    </header>
    ...
    <main class="flex-1 overflow-y-auto pt-20 pb-20 px-6">
      ...
      <div class="max-w-4xl mx-auto mb-12 text-left">
        <h2
          class="items-start justify-start text-3xl font-bold mb-4 text-gray-600"
        >
          Text Converter
        </h2>
